            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>GET IN TOUCH</h2>
                        <p>You can send requests, comments or questions to us by filling out the contact form below. We will try to respond as soon as possible.

                           <br> Thank you very much for your interest and support to our store.</p>
                        <form id="contactForm">
                            <div class="row">
                                <div class="col-md-12">
				...
				<div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        <h2>CONTACT INFO</h2>
                        <p>We are always ready to listen and answer all your questions. To contact our store, please use the information below: </p>
                        <ul>
                            <li>
